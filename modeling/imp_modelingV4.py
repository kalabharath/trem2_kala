...
"""
Author: kalabharath@gmail.com
Changelog:
1: 14/01/2020: Refactored Leah's (ray.leahc@gmail.com) original script.
...
def create_fibril_transforms(z_displacement, len_protofilament):
    ...
    :param z_displacement:
    :param len_protofilament:
    :return:
    """
    transforms = []
...
xl_data_NHSF = "../data/xl/bs3_nshsf_mixed.csv"  # Experimental cross-links set-2 20 A long.
xl_weight = 1.0
...
chains = ['A', 'G', 'M']
additional_chains = ['B', 'C', 'D', 'E', 'F', 'H', 'I', 'J', 'K', 'L', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W',
                     'X', 'Y', 'Z', 'B', 'C', 'D', 'E', 'F', 'H', 'I', 'J', 'K', 'L', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W',]
count = 0
...
# ----------------------------- SAMPLING ------------------------------------
for n in range(11,51):  # run 10 independent runs over #no of replicas suggested by mpirun
